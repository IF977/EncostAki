Rails.application.configure do
  ...
  Rails.application.routes.default_url_options[:host] = 'encostakiapp.herokuapp.com'
  config.action_mailer.default_url_options = { :host => 'encostakiapp.herokuapp.com' }
  ...
  # config.active_job.queue_name_prefix = "EncostAki_#{Rails.env}"
